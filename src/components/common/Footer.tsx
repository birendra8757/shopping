    ...
    <footer className="bg-gray-100 text-gray-800 border-t">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="mb-2">
            <span className="font-medium">Email :</span> info@thequantumweb.shop
          </p>
          <p className="mb-4">
            <span className="font-medium">Call :</span> +1 (844)-403-3240
          </p>
          ...
          <img src="/Norton-Logo2.png" alt="Norton" className="h-16 mb-3 w-72" />
           <img src="/business.png" alt="Norton" className="h-18 w-64 mb-3 ml-4" />
        </div>
